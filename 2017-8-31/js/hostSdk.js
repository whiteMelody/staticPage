...
(function () {
    ...
    window.host_sdk = {
        ...
        // 操作成功后回调
        successCallback: function successCallback(platform) {}
    };
    ...
    window.hostsdk = {
        ...
        //用户充值
        recharge: function recharge(options) {
            if (options.successCallback) window.host_sdk.successCallback = options.successCallback;
            if (options.errorCallback) window.host_sdk.errorCallback = options.errorCallback;
            if (options.cancelCallback) window.host_sdk.cancelCallback = options.cancelCallback;
            if (client_tool.isApple) {
        ...
        //手动关闭
        exit: function exit(errorCallback) {
        ...
        //设置左侧按钮
        leftIcon: function leftIcon(options) {
            if (options.successCallback) window.host_sdk.successCallback = options.successCallback;
            if (options.errorCallback) window.host_sdk.errorCallback = options.errorCallback;
            if (client_tool.isApple) {
        ...
        //设置右侧按钮
        rightIcon: function rightIcon(options) {
            if (options.successCallback) window.host_sdk.successCallback = options.successCallback;
            if (options.errorCallback) window.host_sdk.errorCallback = options.errorCallback;
            if (client_tool.isApple) {
        ...
        //OpenCourse打开课程
        OpenCourse: function OpenCourse(options) {
            if (options.successCallback) window.host_sdk.successCallback = options.successCallback;
            if (options.errorCallback) window.host_sdk.errorCallback = options.errorCallback;
            if (client_tool.isApple) {
        ...
        //OpenCategory查看更多
        OpenCategory: function OpenCategory(options) {
