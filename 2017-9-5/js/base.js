...
var base = {
    ...
    getTickets: function getTickets(type) {
        ...
        if (type == 'ssq') {
            _ticket = base.getCookie('ssq_ticket');
        }
        if (type == 'dlt') {
            _ticket = base.getCookie('dlt_ticket');
        }
        if (type == 'd11') {
            _ticket = base.getCookie('d11_ticket');
        }
        if (type == 'q3') {
            _ticket = base.getCookie('q3_ticket');
        }
    ...
    delTicketByID: function delTicketByID(ticketID, type) {
        ...
        if (type == 'ssq') {
            base.setCookie('ssq_ticket', _tickets);
        }
        if (type == 'dlt') {
            base.setCookie('dlt_ticket', _tickets);
        }
        if (type == 'd11') {
            base.setCookie('d11_ticket', _tickets);
        }
        if (type == 'q3') {
            base.setCookie('q3_ticket', _tickets);
        }
