...
var baseAjax = {
     ...
     * @param callback
     */
    payMatch: function payMatch(matchID, lotType, anteValue, couponNumber, money, callback) {
        ...
        $.ajax({
            ...
            data: { matchID: _sign.matchID, lotType: _sign.lotType, anteValue: _sign.anteValue, couponNumber: _sign.couponNumber, money: _sign.money, uuid: _sign.uuid, deviceID: _sign.deviceID, source: _sign.source, deviceType: _sign.deviceType, s: _sign.s, t: _sign.t },
            dataType: "json",
            success: function success(data) {
                if (data.status == 1) {
                    callback(data);
     ...
     * @param callback
     */
    createMatchOrder: function createMatchOrder(matchID, lotType, anteValue, couponNumber, money, callback) {
     ...
     * @param callback
     */
    focusUser: function focusUser(focusUUID,uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            focusUUID: focusUUID,
            uuid: uuid,
            deviceID: deviceID,
     ...
     * @param callback
     */
    cancelFocusUser: function cancelFocusUser(focusUUID,uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            focusUUID: focusUUID,
            uuid: uuid,
            deviceID: deviceID,
     ...
     * @param callback
     */
    addressList: function addressList(pageIndex, pageSize, uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            pageIndex: pageIndex,
            pageSize: pageSize,
            uuid: uuid,
     ...
     * @param callback
     */
    addAddress: function addAddress(recipients, mobilePhone, address, uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
     ...
     * @param callback
     */
    editAddress: function editAddress(addressID, recipients, mobilePhone, address, uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            addressID: addressID,
            recipients: recipients,
            mobilePhone: mobilePhone,
     ...
     * @param callback
     */
    delAddress: function delAddress(addressID, uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            addressID: addressID,
            uuid: uuid,
            deviceID: deviceID,
     ...
     * @param callback
     */
    defaultAddress: function defaultAddress(addressID, uuid, deviceID, source, deviceType,callback) {
        var _sign = baseAjax.getAjaxSign({
            addressID: addressID,
            uuid: uuid,
            deviceID: deviceID,
    ...
    createOrder: function createOrder(goodsid, username, telephone, address ,uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            goodsid: goodsid,
            username: username,
            telephone: telephone,
     ...
     * @param callback
     */
    orderList: function orderList(page, pageSize,uuid, deviceID, source, deviceType, callback) {
        var _sign = baseAjax.getAjaxSign({
            page: page,
            pageSize: pageSize,
            uuid: uuid,
     ...
     * @param callback
     */
    alipayWapForApp: function alipayWapForApp(totalFee, returnUrl, attType, attInfo, callback) {
        var data = {
            totalFee: totalFee,
            returnUrl: returnUrl
        };
