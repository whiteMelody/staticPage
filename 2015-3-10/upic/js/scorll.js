...
$(function() {
		...
		$(".thumbBtn").toggle(function(){
			$("#thumbContainter").animate({marginRight:'0px'},300);
			$(".title-right").animate({marginRight:'200px'},300);
			$(".edit").animate({marginRight:'200px'},300);
		},function(){
			$("#thumbContainter").animate({marginRight:'-400px'},500);
			$(".title-right").animate({marginRight:'0'},300);
			$(".edit").animate({marginRight:'0'},300);
		});
		...
		var $scrollerContent	= $thumbScroller.find('.content2');
		...
		$thumbScroller.find('img').each(function(){
			...
			$('<img/>').load(function(){
				...
				if(cnt == scrollerContentCnt){
					//one items height
					itemHeight = $thumbScroller.find('.content2:first').height();
